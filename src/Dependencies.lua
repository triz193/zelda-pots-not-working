...
require 'src/states/entity/player/PlayerWalkingWithPotState'
...
gTextures = {
    ...
    ['extra_heart'] = love.graphics.newImage('graphics/hearts.png')
...
gFrames = {
    ...
    ['extra_heart'] = GenerateQuads(gTextures['extra_heart'], 16, 16)
...
gSounds = {
    ...
    ['extra_heart'] = love.audio.newSource('sounds/extra_heart.wav', 'static'),
    ['full_heart'] = love.audio.newSource('sounds/full_heart.wav', 'static') 

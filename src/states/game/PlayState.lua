...
function PlayState:init()
    ...
    self.player.stateMachine = StateMachine {
        ...
        ['lifting-pot'] = function() return PlayerLiftingPotState(self.player, self.dungeon, self.pot) end,
        ['walking-with-pot'] = function() return PlayerWalkingWithPotState(self.player, self.dungeon, self.pot) end
    }
